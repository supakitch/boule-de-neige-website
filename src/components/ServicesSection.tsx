    ...
    backgroundColor: "#ffece8"
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return <article key={index} className="bg-card rounded-xl p-8 hover:scale-105 transition-transform duration-300 hover:shadow-lg group">
                <div className={`w-16 h-16 ${service.color} mb-6 group-hover:animate-shake`} aria-hidden="true">
                  <IconComponent className="w-full h-full" />
                </div>
                <h3 className="text-xl font-bold font-jost text-primary mb-3">{service.title}</h3>
