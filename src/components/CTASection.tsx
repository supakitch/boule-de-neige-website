...
export const CTASection = () => {
  ...
  return <section id="contact" className="py-20 bg-gradient-hero" aria-labelledby="cta-title">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto text-center">
          <div className="mb-12">
            <img src={huskyTongue} alt="Mascotte Husky joyeuse tirant la langue - prête à démarrer votre stratégie d'outreach" className="w-32 h-32 mx-auto mb-8 animate-bounce" style={{
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-12">
            <a href="https://zcal.co/mcomptier/30min" target="_blank" rel="noopener noreferrer">
              <Button ref={buttonRef} variant="airbnb" size="lg" className="text-lg px-10 py-6 font-['Jost']" aria-label="Planifier un audit gratuit de 15 minutes avec notre équipe" onMouseMove={handleMouseMove} style={{
            ...
            <a href="mailto:camille@boule2neige.fr">
              <Button variant="outline" size="lg" className="text-lg px-10 py-6 bg-card hover:bg-card-secondary hover:text-foreground" aria-label="Nous contacter pour discuter de votre projet">
          ...
          <div className="grid md:grid-cols-3 gap-6 text-center">
            ...
            <div className="bg-card p-6 rounded-xl">
              <div className="text-3xl font-bold text-accent-pink mb-2">15 jours</div>
