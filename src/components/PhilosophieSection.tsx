        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-[40%_60%] gap-12 items-center">
            ...
            <div className="space-y-8 max-w-3xl">
              ...
              <blockquote className="relative" style={{ marginBottom: "50px" }}>
              ...
              <div className="bg-card-secondary p-6 rounded-xl mt-[60px]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
                ...
                <div className="bg-card p-4 rounded-lg">
                  <div className="text-lg md:text-xl font-bold text-accent-pink mb-1 whitespace-nowrap">Accompagnement</div>
